...
CREATE OR REPLACE VIEW estoque_atual_produtos AS
SELECT 
    p.id as produto_id,
...
-- Inserir lotes de exemplo se não existirem
INSERT IGNORE INTO lotes (produto_id, numero_lote, quantidade, data_validade, data_fabricacao) VALUES
